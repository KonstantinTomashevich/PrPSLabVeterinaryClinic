...
public class PatientDatabaseAcessor {
    ...
    public void AddClient(final ClientData client) throws IDConflictException, IncorrectDataException {
    }
    ...
    public void AddPatient(final PatientData patient) throws IDConflictException, IncorrectDataException {
    }

    @objid ("48afb474-5371-43ff-9821-b6e37e656ad6")
    public void ChangePatientField(final int patientId, final EditablePatientFields field, final String newValue) throws IDNotFoundException, IncorrectDataException {
    }

    @objid ("8278126e-5c0f-4b2c-ad24-545b39d88c43")
    public void ChangeClientField(final int clientId, final EditableClientFields field, final String newValue) throws IDNotFoundException, IncorrectDataException {
    }
